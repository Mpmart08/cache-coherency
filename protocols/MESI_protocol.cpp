...
inline void MESI_protocol::do_cache_M (Mreq *request)
{
    ...
    case STORE:
        ...
        // write data in cache and give to processor
        send_DATA_to_proc(request->addr);
        break;
...
inline void MESI_protocol::do_snoop_E (Mreq *request)
{
    ...
    case GETS:
        ...
        // supply data on bus, data is no longer exlusive, it is shared
        set_shared_line();
...
inline void MESI_protocol::do_snoop_M (Mreq *request)
{
    ...
    case GETS:
        ...
        // supply data on bus, writeback to memory, and data becomes shared
        set_shared_line();
        send_DATA_on_bus(request->addr,request->src_mid);
        state = MESI_CACHE_S;
        break;
...
inline void MESI_protocol::do_snoop_IM (Mreq *request)
{
    ...
    case DATA:
        ...
        // get data from bus and modify it
        send_DATA_to_proc(request->addr);
        state = MESI_CACHE_M;
        break;
